...
# Estudiantes
    ...
    #---------------------------
        ...
        html_button = f'<a download="tutorias.xlsb" href="data:application/octet-stream;base64,{base64_pdf}" class="custom-download-button" target="_blank" style="text-decoration:none; color:inherit;">Descargar horas de tutorías</a>'
