...
with st.expander("Antes de comenzar debes saber las ventajas e desventajas del uso de los modelos LLMs:"):
  
  st.markdown(f"<p style='{custom_subtitle}'>Ventajas:</p>", unsafe_allow_html=True)
  st.markdown(f"<p style='{custom_style}'><b>Acceso rápido a información</b>: GPT-4 puede proporcionar respuestas rápidas y relevantes a preguntas, lo que permite a los estudiantes investigar temas y obtener información de manera eficiente.</p>", unsafe_allow_html=True)
  st.markdown(f"<p style='{custom_style}'><b>Generación de ideas</b>: GPT-4 puede ayudar a los estudiantes a explorar nuevas perspectivas y generar ideas para sus proyectos de investigación o tareas.</p>", unsafe_allow_html=True)
  st.markdown(f"<p style='{custom_style}'><b><b>Desarrollo de habilidades de redacción</b>: GPT-4 puede servir como una herramienta para mejorar las habilidades de redacción de los estudiantes al proporcionar ejemplos de escritura de alta calidad y ayudar a mejorar el estilo y la gramática.</p>", unsafe_allow_html=True)
  st.markdown(f"<p style='{custom_style}'><b>Facilitar el aprendizaje de idiomas</b>: GPT-4 puede ser útil para estudiantes que aprenden nuevos idiomas al proporcionar traducciones, ejemplos de uso de vocabulario y práctica en la construcción de frases.</p>", unsafe_allow_html=True)
  st.markdown(f"<p style='{custom_style}'><b>Soporte para la enseñanza</b>: GPT-4 puede ser utilizado como un recurso adicional para profesores, proporcionando ejemplos, explicaciones y material adicional para apoyar la enseñanza.</p>", unsafe_allow_html=True)
  
  st.markdown(f"<p style='{custom_subtitle}'>Desventajas:</p>", unsafe_allow_html=True)
  st.markdown(f"<p style='{custom_style}'><b>Confiabilidad de la información</b>: GPT-4 puede generar respuestas incorrectas o desactualizadas, lo que podría llevar a los usuarios a obtener información errónea. GPT-4 puede generar información falsa sin previo aviso, en ocasiones en medio de un texto que, por lo demás, es preciso</p>", unsafe_allow_html=True)
  st.markdown(f"<p style='{custom_style}'><b>Integridad académica</b>: La facilidad con la que GPT-4 puede generar contenido bien redactado puede fomentar la dependencia excesiva por parte de los estudiantes en el trabajo generado por la IA, en lugar de desarrollar y demostrar sus habilidades y conocimientos originales, lo que socava la integridad académica.</p>", unsafe_allow_html=True)
  st.markdown(f"<p style='{custom_style}'><b><b>Falta de pensamiento crítico</b>: La dependencia excesiva de GPT-4 puede disuadir a los estudiantes de desarrollar habilidades de pensamiento crítico y análisis independiente.</p>", unsafe_allow_html=True)
  st.markdown(f"<p style='{custom_style}'><b>Sesgo y discriminación</b>: GPT-4 puede reflejar y perpetuar sesgos y estereotipos presentes en los datos de entrenamiento, lo que podría llevar a conclusiones incorrectas o discriminatorias.</p>", unsafe_allow_html=True)
  st.markdown(f"<p style='{custom_style}'><b>Falta de habilidades de comunicación</b>: El uso excesivo de GPT-4 puede limitar las oportunidades de los estudiantes para desarrollar habilidades de comunicación interpersonal, ya que pueden depender en exceso del modelo en lugar de interactuar directamente con profesores y compañeros de clase.</p>", unsafe_allow_html=True)
separador("#B30A1B")
#------------------------------------------------#
