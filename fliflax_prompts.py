...
st.markdown(f"<p style='{custom_style}'>Finalmente, aquí puedes consultar el texto del prompt para su inclusión en la consola del modelo (por ejemplo, ChatGPT).</p>", unsafe_allow_html=True)
