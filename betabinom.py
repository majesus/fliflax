...
if st.checkbox("Si deseas ver la expresión matemática empleada, marca la casilla.", False):
    ...
    st.warning("**A** y **B** son los parámetros de forma alpha y beta, y n el número de inserciones contratadas; **i** es el valor de la distribución de contactos "
               "que pudiere interesarnos, "
