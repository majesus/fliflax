...
audience = st.text_input("¿Quiénes son los destinatorios de la respuesta esperada?", "")
...
objectives_tasks = st.text_area("¿Cuáles son los objetivos que persigues preguntando, y las tareas necesarias para lograr los objetivos?", "")
...
extension = st.selectbox("¿Qué longitud deseas que tenga la respuesta esperada?", ["", "corto", "medio", "largo"])
separador("#B30A1B")
#------------------------------------------------#
