...
def obtener_info_investigador(url):
    ...
    grupo_a = soup.find("span", string="Grupo: ").find_next("a") if soup.find("span", string="Grupo: ") else None
    grupo = grupo_a.text.strip() if grupo_a else "No disponible"
    URL_grupo = grupo_a['href'] if grupo_a else "No disponible"
    ...
    return nombre, categoria, email, area_conocimiento, departamento, grupo, instituto_inv, prog_doctorado, URL_grupo
...
for url in urls:
    ...
    nombre, categoria, email, area_conocimiento, departamento, grupo, instituto_inv, prog_doctorado, URL_grupo = obtener_info_investigador(url)
    ...
    data["URL_grupo"].append(URL_grupo)
