...
p = st.multiselect('Probabilidades marginales de cada medio', [0.1, 0.2, 0.3, 0.4], [0.4, 0.3, 0.2, 0.1])  

inserciones = st.multiselect('Número de inserciones en cada medio', [1, 2, 3, 4], [2, 3, 4, 1])  
